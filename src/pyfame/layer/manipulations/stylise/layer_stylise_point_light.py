...
def layer_stylise_point_light(point_density:float = 1.0, point_color:tuple[int] = (255,255,255), maintain_background:bool = True, display_history_vectors:bool = False, 
                 history_method:int|str = SHOW_HISTORY_ORIGIN, history_window_msec:int = 500, history_color:tuple[int] = (0,0,255), time_onset:float=None, 
                 time_offset:float=None, timing_function:Callable[...,float]=timing_linear, region_of_interest:list[list[tuple]] = [FACE_OVAL_PATH], fade_duration:int = 500, 
                 min_tracking_confidence:float = 0.5, min_detection_confidence:float = 0.5, **kwargs):
    
    return LayerStylisePointLight(point_density, point_color, maintain_background, display_history_vectors, history_method, history_window_msec, 
                                  history_color, time_onset, time_offset, timing_function, region_of_interest, fade_duration, min_tracking_confidence, min_detection_confidence, **kwargs)