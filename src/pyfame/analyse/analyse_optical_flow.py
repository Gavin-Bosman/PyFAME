...
def analyse_optical_flow_sparse(file_paths:pd.DataFrame, landmarks_to_track:list[int]|None = None, max_corners:int = 20, corner_quality_level:float = 0.3, 
    ...
    point_colour: tuple of int
        The colour of the points in the output image.
    
    point_radius: int
        The radius of the points in the output image.
    
    vector_colour tuple of int or None
        The colour of the vectors in the output image. If None, these colours are randomly generated.
    ...
    check_value(point_radius, min=1)
