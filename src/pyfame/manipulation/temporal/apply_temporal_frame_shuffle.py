...
def apply_frame_shuffle(input_dir:str, output_dir:str, shuffle_method:int = FRAME_SHUFFLE_RANDOM, rand_seed:int|None = None, block_order:tuple|None = None, 
    ...
    output_dir = create_output_directory(output_dir, "Frame_Shuffled")
