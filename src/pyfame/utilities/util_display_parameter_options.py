...
def display_colour_space_options() -> None:
    print(
...
def display_shift_colour_options() -> None:
    print(
        "Face Colour Shift Coloring Options:\n"
        "   - COLOUR_RED (literal [4])\n"
        "   - COLOUR_BLUE (literal [5])\n"
        "   - COLOUR_GREEN (literal [6])\n"
        "   - COLOUR_YELLOW (literal [7])\n"
    )
